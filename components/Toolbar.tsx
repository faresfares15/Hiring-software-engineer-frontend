...
export default function Toolbar({ editor }: Props) {
	...
	return (
		<div className={"flex p-4 gap-1.5"}>
			<button
				className={`flex items-center justify-center cursor-pointer rounded-md h-8 w-8 bg-white text-gray-800 border-none shadow-md hover:text-gray-900 hover:shadow-hoverButton focus:outline-none focus:ring-2 active:shadow-activeButton ${editor.isActive("bold") ? "bg-gray-200" : ""}`}
			...
			<button
				className={`flex items-center justify-center cursor-pointer rounded-md h-8 w-8 bg-white text-gray-800 border-none shadow-md hover:text-gray-900 hover:shadow-hoverButton focus:outline-none focus:ring-2 active:shadow-activeButton ${editor.isActive("italic") ? "bg-gray-200" : ""}`}
			...
			<button
				className={`flex items-center justify-center cursor-pointer rounded-md h-8 w-8 bg-white text-gray-800 border-none shadow-md hover:text-gray-900 hover:shadow-hoverButton focus:outline-none focus:ring-2 active:shadow-activeButton ${editor.isActive("strike") ? "bg-gray-200" : ""}`}
